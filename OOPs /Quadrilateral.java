...
public class Quadrilateral
{
    public void vertices()
    {
        ...
        System.out.printf("slopes are \n%f\n%f\n%f\n%f\n",ab,bc,cd,da);
        System.out.printf("Lengths are \n%f\n%f\n%f\n%f\n",AB,BC,CD,DA);
...
//     if((slop(this.ab)==slop(this.cd)) && ((slop(this.bc)!=slop(this.da))))
//     {
//         System.out.println("This is a Trapezium");
//     }
//     else if (slop(this.bc)==slop(this.da)) && ((slop(this.ab)!=slop(this.cd))))
//        {
//            System.out.println("This is a Trapezium");
//        }
//        else
//        {
//               System.out.println("Not a Trapezium");
//        }
//    }
// }